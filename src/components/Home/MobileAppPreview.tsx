      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div ref={headerRef} className="text-center mb-20">
          ...
          <p className="animate-header max-w-3xl mx-auto text-xl text-gray-300 leading-relaxed">
            Experience the full power of our platform on any device. From mobile phones to desktop computers, 
            your digital library is always accessible with the same professional quality and features.
          </p>
        </div>
        ...
        <div ref={featuresRef} className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {mobileFeatures.map((feature, index) => (
              <div key={index} className="feature-item bg-gradient-to-br from-[#1a1a1a] to-[#0f0f0f] border border-gray-800/50 rounded-2xl p-8 shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-black/30 transition-all duration-300 group hover:-translate-y-2">
