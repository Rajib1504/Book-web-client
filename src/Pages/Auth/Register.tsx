        ...
        <div className="w-full max-w-6xl">
          ...
          <div  className="relative max-w-md mx-auto">
            ...
            <div className="text-center">
              <NavLink
                to="/login"
                className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-gray-800/50 to-gray-700/50 hover:from-gray-700/50 hover:to-gray-600/50 border border-gray-600/50 hover:border-gray-500/50 rounded-xl text-gray-300 hover:text-white transition-all duration-300 group"
              >
                <span>Sign In</span>
